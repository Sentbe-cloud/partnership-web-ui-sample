import{a as S}from"./emotion-react-jsx-runtime.browser.esm-aUWFuhMu.js";import{c as x}from"./emotion-react.browser.esm-mnbJeROg.js";import{t as h,f as C,a as n}from"./typography-BLgLjTO_.js";import{b as o}from"./baseColors-DqUdiJtl.js";const v=({children:i,variant:s="body1",color:l="G900",fontFamily:a,fontWeight:r,align:p="left",decoration:d="none",transform:f="none",as:m="span",className:u,style:c})=>{const t=h[s],y=e=>e in o,g=e=>y(e)?o[e]:e,T=x`
    margin: 0;
    padding: 0;
